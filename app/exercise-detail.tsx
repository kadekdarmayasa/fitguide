...
export default function ExerciseDetailScreen() {
  ...
  const { groupLabel, exerciseName } =
    useLocalSearchParams<{ groupLabel: string; exerciseName: string }>();
    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.navHeader}>
        ...
        <View style={styles.navTitleWrap}>
          ...
          <Text style={styles.navTitle}>{exerciseName}</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  badgeText: { fontFamily: 'Rubik_500Medium', fontSize: 10 },
  ...
  anatomyWrap: { borderRadius: 10, overflow: 'hidden' },
  anatomyImage: { width: '100%', height: 169, opacity: 0.8 },
  anatomyOverlay: {
    ...StyleSheet.absoluteFillObject,
  ...
  stepNumber: { fontFamily: 'Rubik_500Medium', fontSize: 12, color: '#000' },
  stepText: {
    flex: 1,
    fontFamily: 'Rubik_400Regular',
    fontSize: 12,
